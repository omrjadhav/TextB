...
class AuthRepository @Inject constructor() {
    ...
    private suspend fun createCometChatUser(uid: String, name: String): Result<com.cometchat.pro.models.User> {
        return suspendCancellableCoroutine { continuation ->
            val user = com.cometchat.pro.models.User()
            user.uid = uid
            user.name = name
            
            CometChat.createUser(user, TextBookApplication.AUTH_KEY, object : CometChat.CallbackListener<com.cometchat.pro.models.User>() {
    ...
    private suspend fun loginCometChat(uid: String): Result<com.cometchat.pro.models.User> {
        return suspendCancellableCoroutine { continuation ->
            CometChat.login(uid, TextBookApplication.AUTH_KEY, object : CometChat.CallbackListener<com.cometchat.pro.models.User>() {
                override fun onSuccess(user: com.cometchat.pro.models.User) {
                    continuation.resume(Result.success(user))
                }
